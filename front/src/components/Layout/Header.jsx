...
function Header() {
    ...
    return(
        <header className="flex items-center justify-between w-full p-2 m-[20px] rounded-full border border-[rgba(255,255,255,0.10)] bg-[#FFFFFF] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.40)] md:md:rounded-none md:bg-transparent md:shadow-none md:border-0 md:border-b md:border-[rgba(0,0,0,0.20)] md:px-[40px] md:py-[30px] md:m-0 text-[#3B82F6] dark:text-[#FFFFFF]">
