...
function Partner() {
    return(
        <div className="">
            ...
            <form className="p-[30px] flex flex-col intems-start gap-[20px] self-stretch font-[Outfit]">
                ...
                <div className="flex flex-col pb-[10px] justify-start gap-[16px] self-stretch uppercase placeholder:uppercase">
                    <label htmlFor="" className="text-[14px] font-semibold tracking-[2.24px]">
                        Titre principal
                    </label>
                    <input type="text" placeholder="le projet marsai" className="placeholder:uppercase placeholder:text-[rgba(255, 255, 255, 0.70)] placeholder:text-[14px] placeholder:tracking-[2.24px] flex py-[11px] px-[21px] items-center self-stretch gap-[10px] rounded-[5px] border border-[rgba(0,0,0,0.10)] bg-[rgba(0,0,0,0.07)] dark:border-[rgba(255,255,255,0.10)] dark:bg-[rgba(255,255,255,0.07)] backdrop-blur-[2.4px]"/>
                </div>
                ...
                <div className="flex items-center justify-center gap-[10px] p-[10px] self-stretch">
                    <div className="uppercase flex w-[288px] h-[182px] flex-col items-center justify-center gap-[12px] px-[43px] py-[34px] rounded-[12px] border-2 border-dashed border-[rgba(0,0,0,0.10)] dark:border-[rgba(255,255,255,0.10)] bg-[rgba(0,0,0,0.07)] dark:bg-[rgba(255,255,255,0.07)] backdrop-blur-[1.5px]">
                        ...
                        <span></span>
                        <input id="logoUpload" type="file" accept="image/png" className="hidden"/>
                ...
                <div className="w-full flex justify-center">
                    <input type="submit" value="Ajouter" className="flex w-[200px] h-[53px] items-center justify-center gap-[13px] px-[21px] py-[10px] rounded-[5px] border border-[#DBE3E6] bg-white dark:border-[rgba(0,0,0,0.11)] dark:bg-[#333]"/>
                </div>
