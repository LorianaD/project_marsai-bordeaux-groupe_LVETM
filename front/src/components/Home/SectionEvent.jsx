            ...
            {isSectionVisible(content, section) && (
                <section className="flex flex-col items-center gap-[20px] md:gap-[96px] md:py-[128px] p-[20px] md:px-[99px] self-stretch">
                    ...
                    <div className="flex flex-col gap-[20px] md:gap-[66px] items-start w-full">
                        ...
                        <Link to={content?.[section]?.ctaAgenda_link} className="flex h-[42px] px-[25px] py-[13px] gap-[8px] justify-center items-center rounded-[100px] border-[rgba(15,15,15,0.1)] bg-[rgba(0,0,0,0.05)] dark:border-white/15 dark:bg-white/15">
                            <div>
                                {ctaAgendaIconSrc ? (
                    ...
                    <div className="flex flex-col md:flex-row gap-8 self-stretch text-left py-[20px] w-full justify-center w-full">
                        ...
                        .map((n) => {
                            ...
                            return (
                                <div key={n} className="max-w-[350px] max-h-[260px] self-stretch row-start-1 row-span-1 col-start-1 col-span-1 justify-self-stretch rounded-[40px] border border-black/10 bg-[rgba(217,217,217,0.1)] p-[40px] flex flex-col gap-[30px] hover:border-[#F1F1F1]/60 hover:bg-[#F1F1F1]/60 hover:text-black w-full">
