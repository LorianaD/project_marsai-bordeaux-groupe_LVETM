                ...
                <section className="flex flex-col md:flex-row md:items-center md:justify-between gap-[20px] px-[20px] md:px-[100px] self-stretch w-full">
                    ...
                    <div className="flex flex-col md:flex-row gap-[48px] px-[20px] md:px-[34px]">
                        {stats.map((n) => {
                            ...
                            return (
                                <div key={n} >
                                    {isVisible(content, section, `stat${n}_value`) && (
                                        <div className="flex w-[294px] h-[193px] flex-col items-center gap-[8px] py-[48px] rounded-[40px] border border-[rgba(0,0,0,0.10)] bg-[rgba(255,255,255,0.05)] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)]">
