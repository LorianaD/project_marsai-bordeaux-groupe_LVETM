...
function SectionHero() {
  ...
  return (
    <section className="relative flex w-full flex-col items-center self-stretch p-[25px] gap-[48px] md:px-[75px] md:gap-[10px]">
      ...
      >
        <source
          src="/imgs/backgroundSections/HomeSectionHero.mp4"
          type="video/mp4"
        />
      </video>
      ...
      <div className="flex py-[24px] flex-col justify-center items-center gap-[50px] self-stretch z-20">
          ...
          <div className="flex px-[17px] py-[9px] justify-center items-start gap-[8px]">
            {isVisible(section, "protocol_icon") && (
              <div className="">
                <img
                  src={
                    resolveCmsAsset(content?.[section]?.protocol_icon) ||
                    t("hero.protocol_icon")
                  }
                  alt=""
          ...
          <p className="text-[#FFFFFF] text-[35px] font-bold tracking-[0.5px] uppercase text-center">
            ...
            {isVisible(section, "tagline_highlight") && (
              <span className="bg-gradient-to-r from-[#AD46FF] via-[#F6339A] to-[#FF6900] bg-clip-text text-transparent">
                {" "}
                {content?.hero?.tagline_highlight ??
        ...
        <div className="flex flex-col items-center justify-center px-[50px] md:flex-row md:items-start md:justify-end gap-6 md:px-[220px]">
          <Link
            to="participation"
            className="flex h-[68px] items-center justify-end gap-[30px] p-[25px] rounded-full bg-white shadow-[0_0_30px_0_rgba(255,255,255,0.1)]"
          >
            ...
            {isVisible(section, "ctaParticipate_signe") && (
              <div className="w-[20px] h-[20px]">
                <img
                  src={
                    resolveCmsAsset(content?.[section]?.ctaParticipate_signe) ||
                    t("hero.ctaParticipate_signe")
                  }
                  alt=""
                />
              </div>
          ...
          <Link
            to="/learn-more"
            className="flex items-center justify-center gap-5 p-[25px] rounded-full border border-white/10 bg-white/5 text-white"
          >
            ...
            {isVisible(section, "ctaLearnMore_signe") && (
              <span className="flex flex-col justify-center text-[#AD46FF] text-center text-[24px] font-bold leading-[0] uppercase">
                {content?.[section]?.ctaLearnMore_signe ||
                  t("hero.ctaLearnMore_signe")}
              </span>
            )}
          </Link>
        </div>
