            ...
            <div className="flex flex-col items-center justify-center gap-[80px] px-6 self-stretch">
                <div className="flex flex-col items-start gap-[50px]">
                    <h2 className="text-right text-[128px] font-bold leading-[128px] tracking-[-6.4px] capitalize text-left">
                        ...
                        <span className="text-[#51A2FF] [-webkit-text-stroke-width:3px] [-webkit-text-stroke-color:#51A2FF] dark:[-webkit-text-stroke-width:3px] dark:[-webkit-text-stroke-color:#51A2FF]">
                            {t("localisationEvent.venue.namePart2")}
                        </span>
                    </h2>
                    <div className="flex items-center gap-[30px] self-stretch">
                        <p className="text-[#51A2FF] text-center text-[10px] font-bold leading-[15px] tracking-[4px] uppercase">
                            {t("localisationEvent.venue.cityTagline")}
                        </p>
                        <p className="text-center text-[18px] font-bold leading-[29.25px]">
                            {t("localisationEvent.address.street")},{" "}
                            {t("localisationEvent.address.postalCode")}{" "}
                            {t("localisationEvent.address.city")}
                        </p>
                        <p className="text-center text-[14px] font-normal leading-[22.75px] tracking-[1.4px] uppercase">
