function SectionGoal() {
    return(
        <section className="flex flex-col items-center justify-center gap-5 px-[75px] py-[20px] self-stretch">
            <h2 className="flex items-start gap-[8px] self-stretch text-[60px] font-bold leading-[60px] tracking-[-3px] uppercase">
                <span className="dark:text-[#FFFFFF]">OBJECTIFS DU </span>
                <span className="text-[#F6339A]">FESTIVAL</span>
            </h2>
            <div className="flex justify-center items-center gap-[48px] self-stretch">
                <div className="w-[300px] rounded-[48px] border border-[rgba(0,0,0,0.1)] bg-[rgba(0,0,0,0.05)] p-[48px] flex flex-col gap-[24px] dark:border-white/10 dark:bg-white/5">
