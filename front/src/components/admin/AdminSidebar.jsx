...
export default function AdminSidebar({ active = "overview" }) {
  ...
  return (
    ...
    <aside className="w-[290px] px-4">
      <div className="flex max-h-[calc(100vh-80px)] flex-col px-5 py-6">
        {/* Bloc profil utilisateur */}
        <div className="rounded-[18px] bg-white p-5 shadow-sm ring-1 ring-black/5 dark:bg-white/5 dark:ring-white/10">
          <div className="flex flex-col items-center">
            <div className="relative">
              <div className="h-[86px] w-[86px] overflow-hidden rounded-full bg-black/5 ring-2 ring-[#B84DFF]/70 dark:bg-white/10">
                <img
                  src="/imgs/avatar.png"
                  alt=""
        ...
        <div className="mt-5 flex-1 overflow-y-auto rounded-[18px] bg-white p-3 shadow-sm ring-1 ring-black/5 dark:bg-white/5 dark:ring-white/10">
        ...
        <div className="pt-6">
          <div className="rounded-[18px] bg-white p-4 shadow-sm ring-1 ring-black/5 dark:bg-white/10 dark:ring-white/10">
            ...
            <button
              type="button"
              className="mt-4 w-full rounded-xl bg-[#0E1628] py-3 text-sm font-semibold text-white hover:bg-[#111c34]"
            >
              Log out
            </button>
          </div>
