    ...
    <main className="bg-black text-white">
      <div className="mx-auto max-w-6xl px-6 py-12 space-y-16">
        ...
        <section id="infos-pratiques" className="space-y-6">
          <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-5 py-2 text-xs font-semibold tracking-[0.25em] uppercase">
          ...
          <article className="mt-6 flex gap-5 rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            ...
            <div className="space-y-2 justify-center w-full ">
              <h3 className="text-sm font-semibold tracking-[0.25em] text-blue-300">
                LA PLATEFORME
              </h3>
          ...
          <ul className="mt-4 space-y-3">
            {[
              ...
              <li
                ...
                className="flex items-start gap-4 rounded-2xl border border-white/5 bg-white/5 px-4 py-3"
              >
                <span
                ...
                <div className="space-y-1">
                  ...
                  {item.speaker && (
                    <p className="text-xs text-white/60 text-left">{item.speaker}</p>
                  )}
                </div>
              </li>
            ))}
        ...
        <section id="acces" className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl border border-white/10 bg-white/5 p-5">
              ...
              <h3 className="text-xs font-semibold tracking-[0.25em] uppercase text-sky-300">
            ...
            <article className="rounded-2xl border border-white/10 bg-white/5 p-5">
              ...
              <h3 className="text-xs font-semibold tracking-[0.25em] uppercase text-emerald-300">
                Voiture
              </h3>
              <p className="mt-3 text-sm text-white/80">
                Avenue Kiff-Saoul 1
            ...
            <article className="rounded-2xl border border-white/10 bg-white/5 p-5">
              <img src={baliseIcon} alt="" className="h-6 w-6" />
              <h3 className="text-xs font-semibold tracking-[0.25em] uppercase text-fuchsia-300">
                Adresses
              </h3>
              <p className="mt-3 text-sm text-white/80">
          ...
          <div className="mt-6 overflow-hidden rounded-3xl border border-dashed border-white/20 bg-white/5 flex justify-center
          ">
            <iframe
        ...
        <section id="ateliers" className="space-y-6 pb-4">
          ...
          <article className="rounded-3xl border border-white/10 bg-white/5 p-6 md:p-8">
            <div className="flex items-center justify-between gap-4">
              <h3 className="font-['Arimo'] text-[30px] font-bold uppercase leading-[36px] tracking-[-1.5px] text-white">
                WORKSHOPS{" "}
            ...
            <ul className="mt-6 grid gap-4 md:grid-cols-2">
              {workshops.length > 0
                ? workshops.map((w) => (
                    <li
                      key={w.id}
                      className="flex flex-col justify-between gap-3 rounded-2xl border border-white/10 bg-black/40 p-5"
                    >
                ...
                : [
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs font-medium tracking-[0.18em] text-white/60">
                          {w.speaker}
                        </p>
                      </div>
                      <p className="text-xs font-medium text-white/80">
