    ...
    <div className="">
      ...
      <div className="mx-auto w-full px-6 pb-14 pt-10">
        <div className="flex gap-7">
          ...
          <section className="w-full mt-5 overflow-hidden rounded-3xl border border-black/10 bg-black/5 dark:border-[#F6339A]/60 dark:bg-white/5">
            <div className="w-full p-6">
              <h2 className="w-full text-xl font-semibold tracking-tight">PLANNING & WORKSHOPS</h2>
