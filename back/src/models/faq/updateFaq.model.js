...
export const updateFaq = async (id, data)=> {
    const query = "UPDATE faq SET display_order = ?, question_fr = ?, question_en = ?, answer_fr = ?, answer_en = ? WHERE id = ?";
    ...
    //Valeur à ajouter.
    const values = [display_order, question_fr, question_en, answer_fr, answer_en, id];
